...
AO_NONE = EnumValue("_ACTIVATEOPTIONS", "AO_NONE", 0x0)
AO_DESIGNMODE = EnumValue("_ACTIVATEOPTIONS", "AO_DESIGNMODE", 0x1)
AO_NOERRORUI = EnumValue("_ACTIVATEOPTIONS", "AO_NOERRORUI", 0x2)
AO_NOSPLASHSCREEN = EnumValue("_ACTIVATEOPTIONS", "AO_NOSPLASHSCREEN", 0x4)
class _ACTIVATEOPTIONS(EnumType):
    values = [AO_NONE, AO_DESIGNMODE, AO_NOERRORUI, AO_NOSPLASHSCREEN]
    mapper = FlagMapper(*values)
ACTIVATEOPTIONS = _ACTIVATEOPTIONS


PES_UNKNOWN = EnumValue("_PACKAGE_EXECUTION_STATE", "PES_UNKNOWN", 0x1)
PES_RUNNING = EnumValue("_PACKAGE_EXECUTION_STATE", "PES_RUNNING", 0x2)
PES_SUSPENDING = EnumValue("_PACKAGE_EXECUTION_STATE", "PES_SUSPENDING", 0x3)
PES_SUSPENDED = EnumValue("_PACKAGE_EXECUTION_STATE", "PES_SUSPENDED", 0x4)
PES_TERMINATED = EnumValue("_PACKAGE_EXECUTION_STATE", "PES_TERMINATED", 0x5)
class _PACKAGE_EXECUTION_STATE(EnumType):
    values = [PES_UNKNOWN, PES_RUNNING, PES_SUSPENDING, PES_SUSPENDED, PES_TERMINATED]
    mapper = FlagMapper(*values)
PACKAGE_EXECUTION_STATE = _PACKAGE_EXECUTION_STATE
...
SICHINT_DISPLAY = EnumValue("_SICHINTF", "SICHINT_DISPLAY", 0x0)
SICHINT_ALLFIELDS = EnumValue("_SICHINTF", "SICHINT_ALLFIELDS", 0x80000000)
SICHINT_CANONICAL = EnumValue("_SICHINTF", "SICHINT_CANONICAL", 0x10000000)
SICHINT_TEST_FILESYSPATH_IF_NOT_EQUAL = EnumValue("_SICHINTF", "SICHINT_TEST_FILESYSPATH_IF_NOT_EQUAL", 0x20000000)
class _SICHINTF(EnumType):
...
GPS_DEFAULT = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_DEFAULT", 0x0)
GPS_HANDLERPROPERTIESONLY = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_HANDLERPROPERTIESONLY", 0x1)
GPS_READWRITE = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_READWRITE", 0x2)
GPS_TEMPORARY = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_TEMPORARY", 0x4)
GPS_FASTPROPERTIESONLY = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_FASTPROPERTIESONLY", 0x8)
GPS_OPENSLOWITEM = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_OPENSLOWITEM", 0x10)
GPS_DELAYCREATION = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_DELAYCREATION", 0x20)
GPS_BESTEFFORT = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_BESTEFFORT", 0x40)
GPS_NO_OPLOCK = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_NO_OPLOCK", 0x80)
GPS_PREFERQUERYPROPERTIES = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_PREFERQUERYPROPERTIES", 0x100)
GPS_EXTRINSICPROPERTIES = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_EXTRINSICPROPERTIES", 0x200)
GPS_EXTRINSICPROPERTIESONLY = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_EXTRINSICPROPERTIESONLY", 0x400)
GPS_MASK_VALID = EnumValue("_GETPROPERTYSTOREFLAGS", "GPS_MASK_VALID", 0x7ff)
class _GETPROPERTYSTOREFLAGS(EnumType):
    ...
    mapper = FlagMapper(*values)
GETPROPERTYSTOREFLAGS = _GETPROPERTYSTOREFLAGS


SIATTRIBFLAGS_AND = EnumValue("_SIATTRIBFLAGS", "SIATTRIBFLAGS_AND", 0x1)
SIATTRIBFLAGS_OR = EnumValue("_SIATTRIBFLAGS", "SIATTRIBFLAGS_OR", 0x2)
SIATTRIBFLAGS_APPCOMPAT = EnumValue("_SIATTRIBFLAGS", "SIATTRIBFLAGS_APPCOMPAT", 0x3)
SIATTRIBFLAGS_MASK = EnumValue("_SIATTRIBFLAGS", "SIATTRIBFLAGS_MASK", 0x3)
SIATTRIBFLAGS_ALLITEMS = EnumValue("_SIATTRIBFLAGS", "SIATTRIBFLAGS_ALLITEMS", 0x4000)
class _SIATTRIBFLAGS(EnumType):
    values = [SIATTRIBFLAGS_AND, SIATTRIBFLAGS_OR, SIATTRIBFLAGS_APPCOMPAT, SIATTRIBFLAGS_MASK, SIATTRIBFLAGS_ALLITEMS]
    mapper = FlagMapper(*values)
SIATTRIBFLAGS = _SIATTRIBFLAGS
